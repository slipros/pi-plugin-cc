---
description: Cancel a running pi job
...
If the script reports that several jobs are running, show their ids and ask the user which one to cancel. Do not guess.
